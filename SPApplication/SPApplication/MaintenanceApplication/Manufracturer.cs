...
namespace SPApplication.Master
{
    public partial class Manufracturer : Form
    {
        ...
        {
            InitializeComponent();
            objDL.SetDesignMaster(this, lblHeader, btnSave, btnClear, btnDelete, btnExit, BusinessResources.LBL_Manufracturer);
        }
        ...
        {
            objRL.TxtValue(sender, e, txtManufractureName);
        }
