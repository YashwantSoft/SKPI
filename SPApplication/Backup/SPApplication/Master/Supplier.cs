...
namespace SPApplication.Master
{
    public partial class Supplier : Form
    {
        ...
        {
            InitializeComponent();
            objBL.Set_Design_All(this, lblHeader, btnSave, btnClear, btnDelete, btnExit, BusinessResources.LBL_HEADER_SUPPLIER);
        }
        ...
        private bool AlreadyExist()
        {
            ...
            objBL.Query = "select ID from Supplier where CancelTag=0 and Trim(SupplierName)='" + ExistValue + "' and  Trim(Address)='" + txtAddress.Text + "' and ID <> " + TableId + "";
                ...
                if (!Validation())
                {
                    ...
                    if (TableId != 0)
                    {
                        ...
                        else
                        {
                            if (!AlreadyExist())
                            {
                                objBL.Query = "update Supplier set SupplierCode='" + txtSupplierCode.Text + "',SupplierName='" + txtSupplierName.Text + "',Address='" + txtAddress.Text + "',MobileNumber='" + txtMobileNumber.Text + "',EmailId='" + txtEmailId.Text + "',GSTNumber='" + txtGSTNumber.Text + "',StateCode='"+txtStateCode.Text+"',UserId= " + BusinessLayer.UserId_Static + " where CancelTag=0 and ID=" + TableId + "";
                                ExecuteType = "Update";
                            }
                        }
                    }
                    ...
                    {
                        objBL.Query = "insert into Supplier(SupplierCode,SupplierName,Address,MobileNumber,EmailId,GSTNumber,StateCode,UserId) values('" + txtSupplierCode.Text + "','" + txtSupplierName.Text + "','" + txtAddress.Text + "','" + txtMobileNumber.Text + "','" + txtEmailId.Text + "','" + txtGSTNumber.Text + "','" + txtStateCode.Text + "'," + BusinessLayer.UserId_Static + ")";
                        ExecuteType = "Save";
                    }
